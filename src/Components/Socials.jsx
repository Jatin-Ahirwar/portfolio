...
const Socials = () => {
  return (
    <div className='animate__animated animate__fadeIn animate__slow w-full h-screen bg-[#FEFEFE] text-[#1F2024] overflow-x-hidden flex flex-col    px-10  '>
        ...
        <div className='h-[20vh] max-md:mt-16 shrink-0 w-full border-b border-[#6D6E77]  flex items-center justify-center pr-12'>
        ...
        <div className='h-full w-full  flex flex-col items-center justify-evenly '>
            ...
            <a href='https://www.linkedin.com/in/jatin-ahirwar-16264820b/' 
              className='text-9xl max-md:text-8xl max-sm:text-7xl max-md:h-fit  border-b-4 rounded border-[#6D6E77] h-[20vh] pb-8 text-[#1F2024] uppercase font-semibold overflow-y-hidden'>
              LinkedIN
            </a>
