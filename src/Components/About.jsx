  ...
  return (
    <div className='animate__animated animate__fadeIn animate__slow w-full overflow-x-hidden flex flex-col max-xs:gap-10  gap-16'>
      <div className='  w-full mt-16 px-8  flex flex-col justify-between max-sm:mt-0 max-sm:pt-20 '>
        <h1 className='no-scrollbar capitalize max-phone:text-[3rem] max-phone:leading-tight py-2 tracking-normal font-black max-xl:text-[4.5rem] max-lg:text-[3.8rem] text-[5.7rem]'> Crafting Innovative Solutions</h1>
        <h1 className='no-scrollbar capitalize max-phone:text-[2.5rem] tracking-wide italic font-thin max-xl:text-[2.9rem]  text-[4.2rem] '>for Seamless Web Development</h1>
      </div>
      ...
      <div className='w-full bg-[#F1F1F3] px-8 max-phone:py-8 max-phone:px-4 py-20 '>
        ...
        <div className='pb-32 w-full max-xss:my-12 max-xss:pb-0 my-24 flex max-xss:grid max-xss:grid-cols-2 max-phone:grid-cols-1 border-b border-zinc-400 '>
            <div className='w-1/4 max-xss:w-full max-xss:h-[50vh] h-full flex flex-col max-phone:h-[30vh] pr-4' >
      ...
      <div className='w-full flex  max-xss:flex-col max-xss:gap-8'>
        ...
        <div className='w-2/6 max-xss:w-full'>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>HTML</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>css</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>javascript</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>Tailwind</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>React.js</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>Next.js</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>Node.js</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>MongoDB</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>express.js</h1>
            <h1 className='text-7xl py-2 uppercase font-black text-[#D2D2D4] max-phone:text-5xl '>figma</h1>
        </div>
      </div>
