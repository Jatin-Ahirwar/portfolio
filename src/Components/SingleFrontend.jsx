...
import { asyncSingleFrontend } from '../../Store/Actions/FrontendActions';
...
const SingleFrontend = () => {
    ...
    return (
        <div className='animate__animated animate__fadeIn animate__slow w-full overflow-x-hidden flex flex-col pt-24 pb-8 px-8 gap-16'>                  
            ...
            <h1 className='no-scrollbar capitalize py-2 tracking-normal font-bold text-8xl'>{singlefrontend?.projectName}</h1>
