...
const Footer = () => {
  return (
    <div className='animate__animated animate__fadeIn animate__slow w-full max-sm:h-[80vh] h-screen bg-[#1F2024] overflow-x-hidden flex flex-col  px-10  '>
      
        <div className='h-[35vh]  max-phone:h-[20vh] no-scrollbar overflow-hidden max-sm:h-[25vh]  max-sm:block max-sm:py-6 max-md:gap-6 max-lg:h-[25vh] shrink-0 w-full border-b border-[#6D6E77]  flex items-center justify-between max-sm:pr-0  pr-12'>
        ...
        <a href='mailto:jatinahirwar1089@gmail.com' target='_blank' rel='noopener noreferrer' id='mail' 
          className='h-[60vh] w-full flex flex-col items-center justify-center  '>
            <h1 className='max-lg:text-[7rem] max-md:text-[5.5rem] max-sm:text-[4.5rem] max-phone:text-[3rem] max-phone:h-[9vh] max-phone:mb-6 text-[9rem] border-b-4 rounded border-[white] tracking-wider text-[#FEFEFE] uppercase font-semibold overflow-y-hidden'  >hello@jatin</h1>
            <h1 className='max-lg:text-[7rem] max-md:text-[5.5rem] max-sm:text-[4.5rem] max-phone:text-[3rem] max-phone:h-[9vh] text-[9rem] border-b-4 rounded border-[white] tracking-wider text-[#FEFEFE] uppercase font-semibold overflow-y-hidden'  >jatin.com</h1>
        </a>
