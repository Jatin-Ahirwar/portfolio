...
//             <h1 className='no-scrollbar capitalize py-2 tracking-normal font-bold text-8xl'>{singleuiux?.projectName}</h1>
...
const SingleUiUx = () => {
    ...
    return (
        <div className='animate__animated animate__fadeIn animate__slow w-full overflow-x-hidden flex flex-col pt-24 pb-8 px-8  max-phone:px-4 max-sm:gap-6 gap-10'>                  
            ...
            <h1 className='no-scrollbar max-phone:text-6xl capitalize py-2 tracking-normal font-bold text-8xl'>{singleuiux?.projectName}</h1>
